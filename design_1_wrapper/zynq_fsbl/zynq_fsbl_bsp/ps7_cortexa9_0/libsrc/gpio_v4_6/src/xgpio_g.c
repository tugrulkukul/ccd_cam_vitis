...
{
	{
		XPAR_GPIO_CONTROL_AXI_GPIO_0_DEVICE_ID,
		XPAR_GPIO_CONTROL_AXI_GPIO_0_BASEADDR,
		XPAR_GPIO_CONTROL_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_GPIO_CONTROL_AXI_GPIO_0_IS_DUAL
	},
	{
